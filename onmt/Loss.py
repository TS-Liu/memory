...
class NMTLossCompute(LossComputeBase):
    ...
    def _compute_loss(self, batch, output, target, tgt_m, tgt_m_p, attn, B):
        ...
        tgt_m_pad_mask = Variable(tgt_m.data.ne(1).float())
        tgt_m_unk_mask = Variable(tgt_m.data.eq(0).float())
        ...
        tgt_m_mask = (tgt_m_pad_mask - tgt_m_unk_mask).unsqueeze(1).repeat(1, tgt_len, 1) * tgt_m_mask
